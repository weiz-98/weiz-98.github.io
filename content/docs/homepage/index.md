...
summary: "Configuring the homepage layout in the Blowfish theme."
...
The author information is provided in the languages configuration file. Refer to the and sections for parameter details.
...
is a guide with more info and a if you want to see an example.
